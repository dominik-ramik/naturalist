...
let staticResources = [
    ...
    "./img/ui/menu/literature.svg",
    "./img/ui/menu/sunburst.svg",
    "./img/ui/menu/hierarchy.svg",
    "./img/ui/menu/view_details.svg",
    ...
    "./img/ui/menu/view_circle_pack.svg",
    "./img/ui/menu/view_category_density.svg",
