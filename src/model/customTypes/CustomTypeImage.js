...
export let customTypeImage = {
  ...
  meta: {
    ...
    notes: [
      {
        type: "tip",
        text: "Arrays of images work with numbered columns: `photo1.source`, `photo1.title`, `photo2.source`, `photo2.title`, referenced as `photo#` in the meta sheet. Use a **Template** to avoid repeating a shared directory path — e.g. `images/{{value}}.jpg` lets you enter just the base filename in each cell.",
      },
    ],
  },
