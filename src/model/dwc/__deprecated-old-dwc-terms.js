...
export const dwcTermInventory = {
    ...
    scientificName: {
        ...
        namespace: "dwc",                        // 1 = checklist required, 2 = occurrence required, 0 = optional enrichment                 // within its tier
    ...
    collectionCode: {
        ...
        namespace: "dwc",    // recommended; absence is a warning not an error
        acceptedNlTypes: ["text"],
        outputFormat: "string",
        vocabulary: null,
        compound: null,
    ...
    decimalLatitude: {
        ...
        namespace: "dwc",    // required only if decimalLongitude is present (cross-field validation)
    ...
    geodeticDatum: {
        ...
        namespace: "dwc",   // required if lat/long rows present (cross-field validation, Tier 2)
        acceptedNlTypes: null,
        outputFormat: "string",
        vocabulary: null,
        compound: null,
    ...
    locality: {
        ...
        namespace: "dwc", required: false, acceptedNlTypes: ["text"], outputFormat: "string",
        vocabulary: null, compound: null, autoGenerate: null, notes: null,
    },
    ...
    organismQuantity: {
        ...
        namespace: "dwc", required: false, acceptedNlTypes: ["number"], outputFormat: "decimal",
        vocabulary: null, compound: null, autoGenerate: null,
        notes: "Use together with organismQuantityType.",
    },

    organismQuantityType: {
        uri: "http://rs.tdwg.org/dwc/terms/organismQuantityType",
        namespace: "dwc", required: false, acceptedNlTypes: ["text", "category"], outputFormat: "string",
        vocabulary: null, compound: null, autoGenerate: null, notes: null,
    },
    ...
    samplingProtocol: {
        ...
        namespace: "dwc",            // tier 3 = sampling event (not implemented in v1)
        acceptedNlTypes: ["text"],
        outputFormat: "string",
        vocabulary: null,
        compound: null,
    ...
    */
    ...
    "dcterms:modified": {
        ...
        acceptedNlTypes: ["date", "text"],
        outputFormat: "iso8601date",
        vocabulary: null, compound: { date: "ymd" }, autoGenerate: null,
        notes: null,
    },
};