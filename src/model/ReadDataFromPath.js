...
registerMessages(selfKey, {
  en: {
    dm_generic_column_names: "Error in column names for formatting of type {0} in the data sheet; we expect either a single column called {1} or multiple columns with the following suffixes: {2}. Also check you don't have the column {3} empty while filling-in the other columns",
  },
  fr: {
