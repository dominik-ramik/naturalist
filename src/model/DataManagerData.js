        ...
        customization: {
          ...
          columns: {
            item: {
              ...
              templateData: ["Color theme hue", "Checklist name", "About section", "How to cite", "Name of checklist data sheet", "Checklist data headers row", "Date format", "Use citations", "Precached image max size", "Stacking circles depth"],
            },
            value: {
              name: "Value",
              description:
              ...
              templateData: [212, "My new checklist", "This is a template checklist. Visit [naturalist.netlify.app](https://naturalist.netlify.app/) to see how to configure it to create a rich taxonomic checklists.\n\nRemember the few things are set in stone with **NaturaList**. The values in this template are there only to get you started. Feel free to modify them and add your own.", "Your citation goes here", "checklist", 1, "MMM D, YYYY", "apa", 0.5, 4],
            },
          },
          data: [],
        },
