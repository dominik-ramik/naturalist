...
let translations = {
  ...
  start_scratch_title: {
    en: "Need a template?",
    fr: "Besoin d'un modèle ?",
  },
  download_blank_sheet_button: {
    en: "Download blank spreadsheet",
    fr: "Télécharger une feuille de calcul vierge",
  },
  starting_from_scratch_links: {
    en: "Starting from scratch or need a reference? Download the blank checklist data spreadsheet using the button below and read the <a href='https://naturalist.netlify.app/'>documentation</a> to see how to fill it in with your own data.",
    fr: "Vous partez de zéro ou avez besoin d'un exemple ? Téléchargez la feuille de calcul de checklist vierge via le bouton ci-dessous et lisez la <a href='https://naturalist.netlify.app/'>documentation</a> pour savoir comment la remplir avec vos propres données.",
  },
  ...
  fresh_install_welcome_message: {
    en: "Looks like a fresh NaturaList here. Glad to have you onboard. May your taxonomic tree grow to the sky!",
    fr: "On dirait un NaturaList tout frais. Contents de vous avoir à bord. Que votre arbre taxonomique pousse jusqu'au ciel !",
  },
  no_data: {
  ...
  new_version_available: {
    en: "A new version of NaturaList is available. Click on this message to refresh the page and complete the update.",
    fr: "Une nouvelle version de NaturaList est disponible. Cliquez sur ce message pour rafraîchir la page et compléter la mise à jour.",
  },
  done: {
    en: "Done!",
    fr: "C'est fait !",
