        ...
        mapRegions: {
          ...
          columns: {
            suffix: {
              name: "Suffix",
              description:
                "On each line a suffix of map regions to be matched against. Empty cell will match regions without suffix (convenient for the common cases ... e.g. 'Native' when making a map of presence in a country).",
              integrity: {
                description:
        ...
        taxa: {
          ...
          columns: {
            ...
            parentTaxonIndication: {
              ...
              description:
                "By default, each taxon is followed by the name of parent taxon in paranthesis.This is useful to e.g. show the family of lower taxa in a longer list. In some instances this behaviior is not needed as the parent taxon is self evident. For example for the species full scientific name the genus is already part of the name so the genus doesn't need to be shown alongside in paranthesis as the parent taxon. Leave the cell empty for a particular taxon if you want to show the name of the immediate parent taxon in paranthesis. Enter 'none' if you want to hide the indication of the parent taxon for that particular taxon. If you wish to show the name of a parent taxon higher up the tree, enter the column name for the corresponding taxon. This may be useful if you have e.g. family, genus and species levels and you want to show the family name by each species; in this case you would insert 'family' in the species row.",
              integrity: {
                description: "",
                allowEmpty: true,
                allowDuplicates: "yes",
        ...
        customDataDefinition: {
          ...
          columns: {
            ...
            hidden: {
              name: "Hidden",
              description:
                "Some of your columns in the checklist sheet may contain data, which you do not want to display directly, but which you nonetheless reference e.g. through a template of another column. You can use this column to make sure your data are loaded, but are kept hidden.",
              integrity: {
                description: "",
                allowEmpty: true,
                allowDuplicates: "yes",
        ...
        media: {
          ...
          columns: {
            ...
            title: {
              name: "Title",
              description:
                "A short title which will be displayed above the group of media of this column.",
              integrity: {
                description: "",
                allowEmpty: true,
                allowDuplicates: "empty-only",
            ...
            typeOfData: {
              name: "Type of data",
              description:
                "If the media is of image type, type <b>image</b> here. If it is a sound, entering <b>sound</b> will display a sound player instead.",
              integrity: {
                description: "",
                allowEmpty: false,
                allowDuplicates: "yes",
                allowedContent: "list",
                listItems: ["image", "sound"],
                supportsMultilingual: false,
              },
            },
            linkBase: {
        ...
        maps: {
          ...
          columns: {
            columnName: {
              name: "Column name",
              description:
                "Name of the column in your checklist sheet which holds the relevant information to generate the map.",
              integrity: {
                description: "",
                allowEmpty: false,
                allowDuplicates: "no",
        ...
        accompanyingText: {
          ...
          columns: {
            columnName: {
              name: "Column name",
              description:
                "Name of the column which holds the accompanying text.",
              integrity: {
                description:
                  "You can enter one or several rows with columns holding your text in the checklist sheet.",
                allowDuplicates: "no",
                allowEmpty: false,
                allowedContent: "columnName",
                supportsMultilingual: false,
